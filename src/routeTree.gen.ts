...
const StudioImageAutoEditRoute = StudioImageAutoEditRouteImport.update({
  id: '/auto-edit',
  path: '/auto-edit',
  getParentRoute: () => StudioImageRoute,
} as any)
const StudioImageCircleRemoveRoute = StudioImageCircleRemoveRouteImport.update({
  id: '/circle-remove',
  path: '/circle-remove',
  getParentRoute: () => StudioImageRoute,
} as any)
const StudioImageMultiRoute = StudioImageMultiRouteImport.update({
  id: '/multi',
  path: '/multi',
  getParentRoute: () => StudioImageRoute,
} as any)
const StudioImageToolsRoute = StudioImageToolsRouteImport.update({
  id: '/tools',
  path: '/tools',
  getParentRoute: () => StudioImageRoute,
} as any)
const StudioImageFiltersRoute = StudioImageFiltersRouteImport.update({
  id: '/filters',
  path: '/filters',
  getParentRoute: () => StudioImageRoute,
} as any)
const StudioImageLensesRoute = StudioImageLensesRouteImport.update({
  id: '/lenses',
  path: '/lenses',
  getParentRoute: () => StudioImageRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/studio/image/auto-edit': {
      id: '/studio/image/auto-edit'
      path: '/auto-edit'
      fullPath: '/studio/image/auto-edit'
      preLoaderRoute: typeof StudioImageAutoEditRouteImport
      parentRoute: typeof StudioImageRoute
    }
    '/studio/image/circle-remove': {
      id: '/studio/image/circle-remove'
      path: '/circle-remove'
      fullPath: '/studio/image/circle-remove'
      preLoaderRoute: typeof StudioImageCircleRemoveRouteImport
      parentRoute: typeof StudioImageRoute
    }
    '/studio/image/multi': {
      id: '/studio/image/multi'
      path: '/multi'
      fullPath: '/studio/image/multi'
      preLoaderRoute: typeof StudioImageMultiRouteImport
      parentRoute: typeof StudioImageRoute
    }
    '/studio/image/tools': {
      id: '/studio/image/tools'
      path: '/tools'
      fullPath: '/studio/image/tools'
      preLoaderRoute: typeof StudioImageToolsRouteImport
      parentRoute: typeof StudioImageRoute
    }
    '/studio/image/filters': {
      id: '/studio/image/filters'
      path: '/filters'
      fullPath: '/studio/image/filters'
      preLoaderRoute: typeof StudioImageFiltersRouteImport
      parentRoute: typeof StudioImageRoute
    }
    '/studio/image/lenses': {
      id: '/studio/image/lenses'
      path: '/lenses'
      fullPath: '/studio/image/lenses'
      preLoaderRoute: typeof StudioImageLensesRouteImport
      parentRoute: typeof StudioImageRoute
    }
    '/_authenticated/settings': {
