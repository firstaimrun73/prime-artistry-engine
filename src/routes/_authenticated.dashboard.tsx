...
function Dashboard() {
  ...
  const shortcuts = [
    ...
    { to: "/studio/image/tools" as const, label: t("home.exploreTools") },
  ...
  const resources = [
    { to: "/studio/image/tools" as const, icon: Wrench, title: t("home.exploreTools"), body: "Discover image capabilities" },
    ...
    <div className="mx-auto max-w-5xl px-4 py-10 pb-24 md:py-12 md:pb-12">
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-xl border border-border bg-card p-5">
          ...
          <p className="mt-1 text-[11px] text-muted-foreground">From recent load</p>
        </div>
      </div>
      ...
      {/* Account resources — profile-only nav layer */}
      <section className="mt-8">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">
          Account & resources
        </h2>
