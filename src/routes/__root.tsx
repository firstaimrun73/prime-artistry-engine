...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Mot2Edit, powered by Motion2AI. Edit images, generate videos, and create music with AI — one workspace, three studios." },
      ...
      { name: "twitter:title", content: "Mot2Edit — AI Image, Video & Music Studio by Motion2AI" },
