  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 pb-24 md:pb-12">
      ...
      {tab === "music" ? (
        ...
        <div className="mt-8 grid grid-cols-2 items-start gap-3 sm:grid-cols-3 sm:gap-4 lg:grid-cols-4">
          {visibleGens.map((g) => {
            ...
            return (
              <button
                ...
                onClick={() => open(g)}
                className={cn(
                  "group h-fit w-full self-start overflow-hidden rounded-xl border bg-card text-left transition-colors",
                  styles.border,
                )}
              >
