...
function CircleRemovePage() {
  ...
  const statusForMode = () => {
    ...
    if (mode === "remove") return "Circle an object, then tap Remove Object";
    if (mode === "add") return "Mark area, then open Assets";
    ...
    phase === "select" || phase === "upload" ? (
      mode === "remove" ? (
        <section className="flex shrink-0 flex-col gap-1.5 border-t border-[#2A2E3A] bg-[#1A1C24] px-3 py-2.5 sm:px-4">
          {drawToolsBar}
          <p className="text-center text-[11px] text-[#9AA0B0]">Circle an object, then tap Remove Object</p>
        </section>
      ) : mode === "add" ? (
            ...
            <button
              ...
              className={cn(
                ...
                addDrawerOpen
                  ...
                  : "border border-[#2E3140] bg-[#22252F] text-[#E8E9ED] hover:border-[#A89BFF]/50",
              )}
            >
        ...
        <section className="flex shrink-0 flex-col gap-1.5 border-t border-[#2A2E3A] bg-[#1A1C24] px-3 py-2.5 sm:px-4">
          ...
          <p className="text-center text-[11px] text-[#9AA0B0]">
            Ratio: <span className="font-semibold text-[#C5C7D0]">{cropRatio}</span>
          </p>
        </section>
      ) : null
    ) : null;
                ...
                >
                  <span
                    className={cn(
                      ...
                      selected ? "border-[#A89BFF] bg-[rgba(168,155,255,0.14)]" : "border-[#2E3140] bg-[#22252F]",
                    )}
                  >
                    {glyph}
                  </span>
