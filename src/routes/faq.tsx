...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What payment methods are supported?", a: "Card (Stripe) everywhere, plus Crypto in supported regions. Switch currency on the pricing page to see local options." },
    ],
  },
  {
