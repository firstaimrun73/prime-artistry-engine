...
/**
 * Miniature / tilt-shift: strong selective focus plane.
 * Focus band tracks content-aware subject Y; progressive blur above/below.
 * Boosted micro-contrast + saturation for toy/model look. No aspect crop.
 */
...
/**
 * Starflare: content-responsive.
 * Highlight brightness → intensity, size → scale, position → origin.
 * Nearly invisible when no suitable bright source exists.
 */
...
/**
 * Radial bokeh: sharp around content-aware focus, soft edges.
 */
