...
/** Deep navy shell — high-contrast light text. Fills viewport to avoid white gaps. */
...
/**
 * Primary Ultra AI action: darker bronze-gold, champagne text — not a bright yellow slab.
 */
