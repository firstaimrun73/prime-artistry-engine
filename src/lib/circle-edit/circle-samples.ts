...
export const CIRCLE_SAMPLES: CircleSample[] = [
  ...
  { id: "add-rabbit", title: "Add a rabbit", description: "Soft fur with ground contact.", mode: "add", assetId: "animal_rabbit", category: "animals", r2Key: `${ADD}/rabbit.jpg`, mediaUrl: U("photo-1585110396000-c9ffd4d4c31a"), aspectRatio: "4:5", quality: "High", sortOrder: 13, active: true },
  { id: "add-fox", title: "Add a fox", description: "Wild look, scene-matched shadows.", mode: "add", assetId: "animal_fox", category: "animals", r2Key: `${ADD}/fox.jpg`, mediaUrl: U("photo-1474511320723-9a56873867b9"), aspectRatio: "4:5", quality: "High", sortOrder: 14, active: true },
  { id: "add-deer", title: "Add a deer", description: "Forest-scale proportions.", mode: "add", assetId: "animal_deer", category: "animals", r2Key: `${ADD}/deer.jpg`, mediaUrl: U("photo-1484406566174-9da253986945"), aspectRatio: "4:5", quality: "High", sortOrder: 15, active: true },
  ...
  { id: "add-vase", title: "Add a vase", description: "Material and contact shadow on surfaces.", mode: "add", assetId: "obj_vase", category: "objects", r2Key: `${ADD}/vase.jpg`, mediaUrl: U("photo-1578500494198-24279b7aa14b"), aspectRatio: "4:5", quality: "High", sortOrder: 23, active: true },
  ...
  { id: "add-scooter", title: "Add a scooter", description: "Compact vehicle, natural placement.", mode: "add", assetId: "vehicle_scooter", category: "vehicles", r2Key: `${ADD}/scooter.jpg`, mediaUrl: U("photo-1558618666-fcd25c85f82e"), aspectRatio: "4:5", quality: "High", sortOrder: 32, active: true },
  { id: "add-motorcycle", title: "Add a motorcycle", description: "Strong silhouette, road contact.", mode: "add", assetId: "vehicle_motorcycle", category: "vehicles", r2Key: `${ADD}/motorcycle.jpg`, mediaUrl: U("photo-1558981403-c5f9899a28bc"), aspectRatio: "4:5", quality: "High", sortOrder: 33, active: true },
  ...
  { id: "add-squirrel", title: "Add a squirrel", description: "Bushy tail, small wildlife scale.", mode: "add", assetId: "animal_squirrel", category: "animals", r2Key: `${ADD}/squirrel.jpg", mediaUrl: U("photo-1507666405890-b885b3fc1ae5"), aspectRatio: "4:5", quality: "High", sortOrder: 41, active: true },
  { id: "add-bus", title: "Add a bus", description: "Transit proportions, ground contact.", mode: "add", assetId: "vehicle_bus", category: "vehicles", r2Key: `${ADD}/bus.jpg", mediaUrl: U("photo-1544620341-1adc1baa1b40"), aspectRatio: "4:5", quality: "High", sortOrder: 42, active: true },
];
