 ...
 * Data: ./core-assets.json — creditCost persisted, never randomized.
 */
import coreAssets from "@/lib/circle-edit/core-assets.json";
...
export const ADD_ASSETS: CircleAddAsset[] = (coreAssets as Seed[]).map((s, i) =>
  finalize(s, i + 1),
);
