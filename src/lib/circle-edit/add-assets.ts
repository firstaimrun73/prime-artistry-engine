...
const ANIMALS: Draft[] = [
  { id: "dog", label: "Dog", keywords: ["dog", "puppy", "pet", "canine", "animal"], glyph: "🐕", generationDescriptor: "a realistic dog" },
  { id: "cat", label: "Cat", keywords: ["cat", "kitten", "pet", "feline", "animal"], glyph: "🐈", generationDescriptor: "a realistic cat" },
  { id: "bird", label: "Bird", keywords: ["bird", "birds", "avian", "sparrow"], glyph: "🐦", generationDescriptor: "a realistic small bird" },
...
const REPTILES: Draft[] = [
  { id: "snake", label: "Snake", keywords: ["snake", "serpent", "reptile", "animal"], glyph: "🐍", generationDescriptor: "a realistic snake" },
...
const PEOPLE_PROPS: Draft[] = [
  { id: "hat", label: "Hat", keywords: ["hat", "cap", "accessory", "clothing", "people"], glyph: "🎩", generationDescriptor: "a realistic hat" },
  { id: "cap", label: "Cap", keywords: ["cap", "baseball", "hat", "clothing"], glyph: "🧢", generationDescriptor: "a realistic baseball cap" },
  { id: "crown", label: "Crown", keywords: ["crown", "royal", "accessory"], glyph: "👑", generationDescriptor: "a realistic crown" },
  { id: "scarf", label: "Scarf", keywords: ["scarf", "clothing", "accessory", "people"], glyph: "🧣", generationDescriptor: "a realistic scarf" },
  { id: "tie", label: "Tie", keywords: ["tie", "necktie", "clothing", "people"], glyph: "👔", generationDescriptor: "a realistic necktie" },
  { id: "shoe", label: "Shoe", keywords: ["shoe", "footwear", "sneaker", "clothing"], glyph: "👟", generationDescriptor: "a realistic shoe" },
  { id: "boot", label: "Boot", keywords: ["boot", "footwear", "clothing"], glyph: "🥾", generationDescriptor: "a realistic boot" },
  { id: "ring", label: "Ring", keywords: ["ring", "jewelry", "jewellery"], glyph: "💍", generationDescriptor: "a realistic ring" },
  { id: "necklace", label: "Necklace", keywords: ["necklace", "jewelry", "jewellery", "chain"], glyph: "📿", generationDescriptor: "a realistic necklace" },
];
...
const FANTASY: Draft[] = [
  { id: "dragon", label: "Dragon", keywords: ["dragon", "fantasy", "myth", "animal"], glyph: "🐉", generationDescriptor: "a realistic fantasy dragon" },
  { id: "unicorn", label: "Unicorn", keywords: ["unicorn", "fantasy", "horse", "animal"], glyph: "🦄", generationDescriptor: "a realistic unicorn" },
  { id: "phoenix", label: "Phoenix", keywords: ["phoenix", "bird", "birds", "fantasy", "fire"], glyph: "🔥", generationDescriptor: "a realistic phoenix bird" },
  { id: "fairy", label: "Fairy", keywords: ["fairy", "fantasy", "magic", "people"], glyph: "🧚", generationDescriptor: "a realistic fairy" },
  { id: "castle", label: "Castle", keywords: ["castle", "fortress", "fantasy"], glyph: "🏰", generationDescriptor: "a realistic castle" },
  { id: "sword", label: "Sword", keywords: ["sword", "blade", "weapon"], glyph: "⚔️", generationDescriptor: "a realistic sword" },
  { id: "shield", label: "Shield", keywords: ["shield", "armor", "protect"], glyph: "🛡️", generationDescriptor: "a realistic shield" },
  { id: "crystal", label: "Crystal", keywords: ["crystal", "gem", "magic", "jewelry"], glyph: "💎", generationDescriptor: "a realistic crystal gem" },
];

const WEATHER: Draft[] = [
  { id: "rainbow", label: "Rainbow", keywords: ["rainbow", "sky", "weather"], glyph: "🌈", generationDescriptor: "a realistic rainbow" },
  { id: "cloud", label: "Cloud", keywords: ["cloud", "sky", "weather"], glyph: "☁️", generationDescriptor: "a realistic cloud" },
  { id: "sun", label: "Sun", keywords: ["sun", "sky", "weather"], glyph: "☀️", generationDescriptor: "a realistic sun" },
  { id: "moon", label: "Moon", keywords: ["moon", "night", "sky"], glyph: "🌙", generationDescriptor: "a realistic moon" },
  { id: "star", label: "Star", keywords: ["star", "night", "sky"], glyph: "⭐", generationDescriptor: "a realistic star" },
  { id: "lightning", label: "Lightning", keywords: ["lightning", "storm", "weather"], glyph: "⚡", generationDescriptor: "a realistic lightning bolt" },
  { id: "snowflake", label: "Snowflake", keywords: ["snowflake", "snow", "winter"], glyph: "❄️", generationDescriptor: "a realistic snowflake" },
  { id: "fire", label: "Fire", keywords: ["fire", "flame", "burn"], glyph: "🔥", generationDescriptor: "realistic fire flames" },
];

const MORE_ANIMALS: Draft[] = [
  { id: "dolphin", label: "Dolphin", keywords: ["dolphin", "ocean", "marine", "animal"], glyph: "🐬", generationDescriptor: "a realistic dolphin" },
  { id: "whale", label: "Whale", keywords: ["whale", "ocean", "marine", "animal"], glyph: "🐋", generationDescriptor: "a realistic whale" },
  { id: "shark", label: "Shark", keywords: ["shark", "ocean", "fish", "animal"], glyph: "🦈", generationDescriptor: "a realistic shark" },
  { id: "octopus", label: "Octopus", keywords: ["octopus", "ocean", "marine", "animal"], glyph: "🐙", generationDescriptor: "a realistic octopus" },
  { id: "crab", label: "Crab", keywords: ["crab", "ocean", "shellfish", "animal"], glyph: "🦀", generationDescriptor: "a realistic crab" },
  { id: "butterfly", label: "Butterfly", keywords: ["butterfly", "insect", "animal"], glyph: "🦋", generationDescriptor: "a realistic butterfly" },
  { id: "bee", label: "Bee", keywords: ["bee", "insect", "honey", "animal"], glyph: "🐝", generationDescriptor: "a realistic bee" },
  { id: "spider", label: "Spider", keywords: ["spider", "insect", "arachnid", "animal"], glyph: "🕷️", generationDescriptor: "a realistic spider" },
  { id: "frog", label: "Frog", keywords: ["frog", "amphibian", "pond", "animal"], glyph: "🐸", generationDescriptor: "a realistic frog" },
  { id: "snail", label: "Snail", keywords: ["snail", "shell", "garden", "animal"], glyph: "🐌", generationDescriptor: "a realistic snail" },
];
...
export const ADD_ASSETS: AddAsset[] = [
  ...
  ...cat("marine", "Marine & bugs", MORE_ANIMALS),
  ...
  ...cat("weather", "Sky & weather", WEATHER),
];
...
export function searchAddAssets(query: string, categoryId?: string | null): AddAsset[] {
  ...
  if (!q) return list;
  const stem = q.endsWith("s") && q.length > 3 ? q.slice(0, -1) : q;
  return list.filter((a) => {
    if (a.label.toLowerCase().includes(q) || a.label.toLowerCase().includes(stem)) return true;
    if (a.id.includes(q) || a.id.includes(stem)) return true;
    if (a.categoryLabel.toLowerCase().includes(q) || a.categoryLabel.toLowerCase().includes(stem)) return true;
    return a.keywords.some((k) => {
      const kk = k.toLowerCase();
      return kk.includes(q) || q.includes(kk) || kk.includes(stem) || stem.includes(kk);
    });
  });
}
