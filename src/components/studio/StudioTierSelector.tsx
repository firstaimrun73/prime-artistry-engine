        ...
        {tiers.map((id) => {
          ...
          return (
            <button
              ...
              onClick={() => onChange(id)}
              className={cn(
                "relative flex min-h-[72px] min-w-0 flex-col items-start gap-0.5 rounded-xl border px-2 py-2 text-left transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring sm:min-h-[80px] sm:px-2.5 sm:py-2.5",
                active &&
                  id === "standard" &&
                ...
                active &&
                  id === "premium" &&
                  "border-[#D4AF37] bg-[#121C30] ring-1 ring-[#D4AF37]/60 text-[#F8F1D8]",
                !active &&
            ...
            >
              {/* Single radio indicator — top-right, consistent for all tiers */}
              <span
                className={cn(
              ...
              <p
                className={cn(
                  "relative line-clamp-1 text-[9px] leading-snug sm:text-[10px]",
              ...
              <p
                className={cn(
                  "relative mt-auto line-clamp-1 text-[9px] leading-snug opacity-90 sm:text-[10px]",
