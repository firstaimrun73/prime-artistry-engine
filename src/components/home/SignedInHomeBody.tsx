...
/** Open-content Unsplash stills (license-clean for UI previews) + local samples. */
const U = {
  interior:
...
export function SignedInHomeBody() {
  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-4 pt-5 pb-24 sm:pt-8 md:pb-12">
      ...
      {/* Auto Edit — dedicated product entry */}
      <Link
        to="/studio/image/auto-edit"
        className="mt-5 flex items-center gap-4 overflow-hidden rounded-2xl border border-primary/40 bg-gradient-to-br from-primary/15 via-card to-card p-4 shadow-md transition-transform hover:scale-[1.01] sm:p-5"
      >
