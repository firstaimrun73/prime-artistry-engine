  ...
  return (
    ...
    >
      <Link
        to="/sample/$id"
        params={{ id: sample.id }}
        className="relative block w-full overflow-hidden bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
      ...
      <div className="px-2 py-1.5">
        <h3 className="text-[11px] font-medium leading-tight line-clamp-1 tracking-tight">{sample.title}</h3>
      </div>
    </article>
  );
}
