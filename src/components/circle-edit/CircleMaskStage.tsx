...
export const CircleMaskStage = forwardRef<CircleMaskStageHandle, Props>(function CircleMaskStage(
  ...
  useImperativeHandle(
    ...
    [scheduleMaskVis, onMaskChange, fit],
  );
        ...
        >
          ...
          {livePath.length > 1 && (
            ...
            >
              <path
                d={pathD}
                fill={pathNearClose ? `rgba(${BRAND}, 0.18)` : "none"}
              ...
              {pathNearClose && livePath.length >= MIN_PATH_POINTS && (
                <path d={pathD + " Z"} fill={`rgba(${BRAND}, 0.22)`} stroke="none" />
              )}
              {terminalA && (
                <circle
                  cx={terminalA.x}
              ...
              {terminalB && (
                <circle
                  ...
                  fill={pathNearClose ? `rgba(${BRAND}, 1)` : `rgba(${BRAND}, 0.7)`}
                  stroke="white"
          ...
          {liveStroke.length > 0 && (
            ...
            >
              <polyline
                ...
                fill="none"
                stroke={liveErase ? "rgba(255,255,255,0.92)" : `rgba(${BRAND}, 0.85)`}
