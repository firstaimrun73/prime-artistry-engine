    ...
    <div className="relative flex h-[100dvh] flex-col overflow-hidden bg-black text-white">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-30 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
        <div className="bg-gradient-to-t from-black via-black/90 to-transparent pt-16">
          <div
            ref={carouselRef}
            className="flex items-end gap-2.5 overflow-x-auto px-[calc(50%-2rem)] pb-3 scrollbar-none"
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    active
                      ? "h-[4.25rem] w-[4.25rem] scale-110 border-white opacity-100"
                      : "h-14 w-14 border-white/25 opacity-60",
                  )}
