  ...
  return (
    <div className="relative flex h-[100dvh] w-full flex-col overflow-hidden bg-black text-white">
      ...
      >
        ...
        {phase !== "result" && (
          <div className="pointer-events-auto absolute right-3 top-[max(4.5rem,calc(env(safe-area-inset-top)+3.5rem))] z-20 flex flex-col gap-2">
            <button
              type="button"
      ...
      <div className="absolute bottom-0 left-0 right-0 z-30 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
        <div className="bg-gradient-to-t from-black via-black/90 to-transparent pt-16">
          ...
          {lens && phase !== "result" && (
            <p className="mb-1.5 text-center text-sm font-semibold tracking-wide text-white/95">
              {lens.name}
              {isAiLens(lens) ? (
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    active
                      ? "h-[4.5rem] w-[4.5rem] scale-110 border-white opacity-100 shadow-[0_0_0_2px_rgba(255,255,255,0.35)]"
