...
export function LensEditor({ initialLensId }: Props) {
  ...
  const startCamera = useCallback(
    ...
    [facingMode, sourceUrl, resultUrl, previewUrl],
  );
    ...
    <div className="relative flex min-h-[100dvh] flex-col bg-black text-white">
      <div className="absolute inset-x-0 top-0 z-40 flex items-center justify-between gap-2 px-3 pb-2 pt-[max(0.75rem,env(safe-area-inset-top))]">
        ...
        <div className="flex flex-col items-center leading-tight">
          <span className="text-[10px] font-semibold tracking-wide text-amber-300/95">Motio2edit</span>
          <span className="text-[11px] font-bold tracking-[0.14em] text-white">LENSES</span>
        </div>
        ...
        {cameraOn && (
          <div className="relative w-full max-w-lg overflow-hidden rounded-3xl border border-white/10 bg-black">
            ...
            <button
              ...
              className="absolute bottom-3 right-3 z-10 flex items-center gap-1.5 rounded-full border border-white/25 bg-black/55 px-3 py-1.5 text-[11px] font-semibold text-white backdrop-blur-md"
              ...
              {CAMERA_LENS_ROSTER.map((l) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={cn(
                        "relative block h-14 w-14 transition-transform",
                    ...
                    >
                      ...
                      >
                        <circle
                          ...
                          r="26"
                          fill="none"
                          stroke={active ? l.color : "rgba(255,255,255,0.35)"}
                      ...
                      {l.tier === "ai" && (
                        <span className="absolute bottom-0.5 left-1/2 z-[1] -translate-x-1/2 rounded-full bg-black/70 px-1 text-[7px] font-bold leading-3 text-amber-300">
                          AI
                        </span>
                      )}
                    </span>
