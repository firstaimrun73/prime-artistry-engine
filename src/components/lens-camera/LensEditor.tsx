...
export function LensEditor({ initialLensId }: { initialLensId?: string }) {
  ...
  return (
    <div className="relative h-[100dvh] w-full overflow-hidden bg-black text-white">
      ...
      <div className="absolute inset-x-0 bottom-0 z-30 pb-[max(0.45rem,env(safe-area-inset-bottom))]">
        ...
        <div className="relative mx-auto flex w-full max-w-md flex-col items-center px-2">
          <div className="relative z-30 mb-1 flex h-6 items-center justify-center">
            {lens && phase !== "result" && (
              <p className="text-center text-[13px] font-semibold tracking-wide text-white/95">
                {lens.name}
                {isAiLens(lens) ? (
          ...
          {phase !== "result" && (
            <div
              className="relative z-30 w-full max-w-[22rem] overflow-visible"
              style={{ height: 76, marginBottom: -12 }}
            >
              {carouselSlots.map((slot) => {
                ...
                const size = isCenter ? 64 : abs === 1 ? 50 : 40;
                const scale = isCenter ? 1 : abs === 1 ? 0.92 : 0.84;
                const opacity = isCenter ? 1 : abs === 1 ? 0.78 : 0.5;
                const xPx = off * SLOT_SPACING_PX;
                const yPx = isCenter ? 0 : abs === 1 ? 8 : 14;
                const z = isCenter ? 30 : abs === 1 ? 20 : 10;
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isCenter
                        ? "border-[2.5px] border-white shadow-[0_0_0_2px_rgba(255,255,255,0.2),0_4px_14px_rgba(0,0,0,0.35)]"
                    ...
                    style={{
                      ...
                      opacity,
                      zIndex: z,
                      transform: `translate(calc(-50% + ${xPx}px), ${yPx}px) scale(${scale})`,
          ...
          <div className="relative z-50 flex items-center justify-center pb-1 pt-1">
            {phase === "result" ? (
              ...
              <button
                ...
                className={cn(
                  "relative grid place-items-center rounded-full border-[3.5px] bg-white/15 active:scale-[0.96]",
                  isAiLens(lens)
